...
class PassportController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('passports.create', $this->data);
    }
    ...
    public function eloquent_passport()
    {
        $passports = DB::table('passports')
        ->where('name', '=', 'aidil rozi')
        ->orWhere(function($query)
        {
            $query->where('email', '=', 'aidilrozi.sani@tri-e.com.my')
                  ->where('number', '=', '193039084');
        })
        ->get();
        echo $passports;
    }
